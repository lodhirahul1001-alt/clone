...
export default function Marquee() {
  ...
  return (
    <section
      className="
        w-screen relative  mt-15 left-1/2 -translate-x-1/2
        overflow-hidden py-6
        bg-white/5 dark:bg-black/20
        border-y border-black/1 dark:border-white/1
      "
    >
      {/* edge fade left */}
      <div className="pointer-events-none absolute left-0 top-0 z-10 h-full w-24 bg-gradient-to-r from-white/9 to-transparent dark:from-black/90" />
      {/* edge fade right */}
      <div className="pointer-events-none absolute right-0 top-0 z-10 h-full w-24 bg-gradient-to-l from-white/9 to-transparent dark:from-black/90" />
