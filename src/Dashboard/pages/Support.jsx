              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="support-card-copy text-sm">+91 73660 42410 </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {[
                  ...
                  <motion.div
                    ...
                    whileHover={{ scale: 1.02 }}
                    className="flex items-center gap-3 p-4 rounded-lg border border-gray-200 dark:border-gray-700 hover:bg-white dark:hover:bg-gray-700/50 cursor-pointer transition-all duration-200"
                  >
                  ...
                  <tbody>
                    {tickets.map((ticket, index) => (
                      <motion.tr
                        ...
                        transition={{ delay: index * 0.1 }}
                        className="border-b border-gray-200 dark:border-gray-700 hover:bg-white dark:hover:bg-gray-700/50 transition-colors"
                      >
                        <td className="p-4">
              ...
              {filteredFAQs.map((faq, index) => (
                ...
                >
                  <button
                    ...
                    className="w-full p-6 text-left flex items-center justify-between hover:bg-white dark:hover:bg-gray-700/50 transition-colors"
                  >
